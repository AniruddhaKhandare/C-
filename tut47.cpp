...
Create 2 classes:
    ...
    the result using another function.
    ...
    Create another class HybridCalculator and inherit it using these 2 classess:
    ...
    Ans - It is called code reusability because we reuse it.
    */
